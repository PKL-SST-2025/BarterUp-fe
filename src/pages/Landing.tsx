        ...
        <header class="bg-black/50 backdrop-blur-md fixed w-full z-50 top-0 left-0">
          <nav class="container mx-auto flex items-center justify-between p-6 sm:px-6 lg:px-32">
            ...
            <div class="hidden md:flex space-x-4">
              <A href="/signup" class="inline-flex items-center justify-center w-28 h-10 text-[#4CE0D2] border-2 border-[#4CE0D2] rounded-[8px] font-semibold text-[14px] hover:bg-[#4CE0D2]/10 focus:outline-none focus:ring-4 focus:ring-[#4CE0D2]/30 transition">Sign Up</A>
              <A href="/login"class="inline-flex items-center justify-center w-28 h-10 bg-[#4CE0D2] text-black rounded-[8px] font-semibold text-[14px] hover:bg-[#4CE0D2]/90 focus:outline-none focus:ring-4 focus:ring-[#4CE0D2]/30 transition"
              >Log In</A>
            </div>
            <button
